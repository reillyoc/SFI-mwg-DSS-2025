...
```{r load data}
# raw fish counts
mcr_fish_1 <- read_csv(here("data_raw", "MCR_LTER_Annual_Fish_Survey_20250324.csv")) 

# taxa table where I cleaned up fish taxonomy and taxonomic resolution
mcr_taxa <- read_csv(here("taxa_tables", "mcr_fish_taxa_annotated.csv"))
```
...
```{r}
write_csv(mcr_fish_6, here("data_cleaned", "mcr_fish_biomass_5x50m2.csv"))
```
